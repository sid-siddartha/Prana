...
export function AppointmentCard({
  ...
  return (
    <>
      <Card className="border-purple-200 hover:border-purple-400/30 transition-all">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center">
                <div className="h-5 w-5 text-purple-400 mr-2">
                  {otherPartyIcon}
                </div>
                <div>
            ...
            {appointment.patientDescription && (
              <div className="space-y-2">
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-purple-200">
                ...
                {userRole === "DOCTOR" &&
                  ...
                  appointment.status !== "CANCELLED" && (
                    <Button
                      ...
                      className="h-7 text-purple-400 hover:text-purple-300 hover:bg-purple-900/20 hover:cursor-pointer"
                    >
              ...
              {userRole === "DOCTOR" && action === "notes" ? (
                <div className="space-y-3">
                  <Textarea
                    ...
                    className="bg-background border-purple-200 min-h-[100px]"
                  />
                ...
                <div className="p-3 rounded-md bg-muted/20 border border-purple-200 min-h-[80px]">
                  {appointment.notes ? (
                    <p className="text-black whitespace-pre-line">
                      {appointment.notes}
                    </p>
            ...
            <div className="flex gap-2">
              ...
              {appointment.status === "SCHEDULED" && (
                <Button
                  ...
                  className="border-red-900/30 text-red-400 hover:bg-red-900/10 mt-3 sm:mt-0 hover:cursor-pointer"
                >
                  {cancelLoading ? (
                    <>
                      <Loader2 className="mr-2 h-4 w-4 animate-spin" />
