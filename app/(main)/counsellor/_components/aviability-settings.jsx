      ...
      <CardContent>
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-purple-100 border border-purple-200"
                    >
          ...
          <form
            ...
            className="space-y-4 border border-purple-200 rounded-md p-4"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background border-purple-200"
                />
                {errors.startTime && (
