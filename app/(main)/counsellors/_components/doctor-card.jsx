...
export function DoctorCard({ doctor }) {
  return (
    <Card className="border-purple-200 hover:border-purple-600/40 transition-all">
      <CardContent>
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-2">
              ...
              <Badge
                variant="outline"
                className="bg-purple-100 border-purple-200 text-purple-600 self-start"
              >
            ...
            >
              <Link href={`/counsellors/${doctor.specialty}/${doctor.id}`}>
